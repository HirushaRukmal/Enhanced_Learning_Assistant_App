...
object DummyRepository {
    ...
    fun getGeneratedTask(): LearningTask {
        return LearningTask(
            ...
            questions = listOf(
                ...
                Question(
                    "Which testing type checks the entire system behaviour?",
                    listOf("Unit Testing", "System Testing", "Smoke Testing", "Mutation Testing"),
                    1
                ),
                Question(
