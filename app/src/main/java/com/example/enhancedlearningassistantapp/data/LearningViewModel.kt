...
class LearningViewModel : ViewModel() {
    ...
    fun generateHint(question: String) {
        ...
        try {
            ...
            _llmState.value = LlmUiState(error = "Failed to generate hint")
        }
    }
    ...
    fun explainAnswer(question: String, correct: String, selected: String) {
        ...
        try {
            ...
            _llmState.value = LlmUiState(error = "Failed to explain answer")
        }
    }
    ...
    fun createFlashcards(topic: String) {
        ...
        try {
            ...
            _llmState.value = LlmUiState(error = "Failed to create flashcards")
        }
    }
    ...
    fun createSummary(topic: String) {
        ...
        try {
            ...
            _llmState.value = LlmUiState(error = "Failed to create summary")
        }
    }
}